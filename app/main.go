...
import (
	...
	_roleRepo "github.com/adhtanjung/go-starter/role/repository/postgresql"
	...
	_userRepo "github.com/adhtanjung/go-starter/user/repository/postgresql"
	_userUcase "github.com/adhtanjung/go-starter/user/usecase"
	_userRoleRepo "github.com/adhtanjung/go-starter/user_role/repository/postgresql"
)
...
func main() {
	...
	configRefreshToken := echojwt.Config{
		ParseTokenFunc: func(c echo.Context, auth string) (interface{}, error) {
	...
	e.GET("/", func(c echo.Context) error {
		...
		return c.HTML(http.StatusOK, `
			<h1>Welcome to Streamlize API!</h1>
		`)
	})
	...
	refreshToken.Use(echojwt.WithConfig(configRefreshToken))
	...
	if err != nil {
		middlewares.MakeLogEntry(nil).Panic("failed to retrieve routes")
	}
	var routes []echo.Route
	err = json.Unmarshal(data, &routes)
	if err != nil {
		log.Panic("Failed to unmarshal routes")
	}
