...
func NewMysqlUserRoleRepository(Conn *gorm.DB) domain.UserRoleRepository {
	return &postgresqlUserRoleRepository{Conn}
}

func (m *postgresqlUserRoleRepository) Store(ctx context.Context, r *domain.UserRole) (err error) {
...
func (m *postgresqlUserRoleRepository) GetByUserID(ctx context.Context, userID uuid.UUID) (res []domain.UserRole, err error) {
